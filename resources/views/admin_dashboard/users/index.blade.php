                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <!-- <div class="ms-auto">
                            <a href="{{ route('admin.users.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                                <i class="bx bxs-plus-square"></i>Thêm tài khoản mới
                            </a>
                        </div> -->
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            ...
                                            <a href="#" onclick="event.preventDefault(); document.querySelector('#delete_form_{{ $user->id }}').submit();" class="ms-3">
