...
<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="{{ asset('kcnew/frontend/img/news.jpg') }}" class="logo-icon" alt="logo icon">
        </div>
        <div>
            <h4 style="color: #00b249" class="logo-text">News</h4>
        </div>
        <div style="color: #00b249" class="toggle-icon ms-auto">
                    ...
                    @if(checkPermission("admin.posts.index"))
                        <li> 
                            <a href="{{ route('admin.posts.index') }}">
                                <i class="bx bx-right-arrow-alt"></i>Tất cả bài viết
                            </a>
                        </li>
                    @endif         
                    ...
                    @if(checkPermission("admin.categories.index"))
                        <li> 
                            <a href="{{ route('admin.categories.index') }}">
                                <i class="bx bx-right-arrow-alt"></i>Tất cả danh mục
                            </a>
                        </li>
                    @endif 
                    ...
                    @if(checkPermission("admin.categories.create"))
                        <li> 
                            <a href="{{ route('admin.categories.create') }}">
                                <i class="bx bx-right-arrow-alt"></i>Thêm danh mục mới
                            </a>
                        </li>
                    @endif 
                </ul>
                    ...
                    @if(checkPermission("admin.comments.index"))
                        <li> 
                            <a href="{{ route('admin.comments.index') }}">
                                <i class="bx bx-right-arrow-alt"></i>Tất cả bình luận
                            </a>
                        </li>
                    @endif
                    ...
                    @if(checkPermission("admin.comments.create"))
                        <li> 
                            <a href="{{ route('admin.comments.create') }}">
                                <i class="bx bx-right-arrow-alt"></i>Thêm bình luận mới
                            </a>
                        </li>
                    @endif    
                </ul>
                    ...
                    @if(checkPermission("admin.roles.index"))
                        <li> 
                            <a href="{{ route('admin.roles.index') }}">
                                <i class="bx bx-right-arrow-alt"></i>Tất cả quyền
                            </a>
                        </li>
                    @endif
                    ...
                    @if(checkPermission("admin.roles.create"))
                        <li> 
                            <a href="{{ route('admin.roles.create') }}">
                                <i class="bx bx-right-arrow-alt"></i>Thêm quyền mới
                            </a>
                        </li>
                    @endif
                </ul>
                    ...
                    @if(checkPermission("admin.users.index"))
                        <li> 
                            <a href="{{ route('admin.users.index') }}">
                                <i class="bx bx-right-arrow-alt"></i>Tất cả tài khoản
                            </a>
                        </li>
                    @endif
                    ...
                    @if(checkPermission("admin.users.create"))
                        <li> 
                            <a href="{{ route('admin.users.create') }}">
                                <i class="bx bx-right-arrow-alt"></i>Thêm tài khoản mới
                            </a>
                        </li>
                    @endif 
                </ul>
